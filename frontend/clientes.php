  ...
  <section class="overflow-hidden d-flex flex-column gap-3 px-2 py-4">
    <div class="d-flex gap-1 align-items-center">
      <nav class="navbar bg-body-tertiary border-0 m-0 p-0">
        <div class="container-fluid">
          <form class="d-flex" role="search" method="post" action="clientes.php">
            <input class="form-control me-3 " type="text" name="id_cliente" placeholder="Buscar cliente" aria-label="Search">
    ...
    <form method="post" action="../backend/api/agregar_cliente.php">
      <div class="row">
        <div class="col">
    ...
    <div class="row row-cols-1 row-cols-md-4 g-4">
      ...
      <?php
      include("../backend/api/db.php"); // Ensure this path is correct

      // Initialize the $id_cliente variable
      $id_cliente = isset($_POST['id_cliente']) ? $_POST['id_cliente'] : null;

      // Prepare the query based on whether $id_cliente is provided
      if ($id_cliente) {
        // Query to get the client by ID
      ...
      foreach ($resultado as $row) { ?>
        <div class="col">
          <div class="card" id="card">
            <div class="card-body">
              <h5 class="card-title"><?php echo htmlspecialchars($row['nombre']) . " " . htmlspecialchars($row['apellido']); ?></h5>
